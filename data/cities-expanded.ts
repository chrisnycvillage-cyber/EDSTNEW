...
export const cities: City[] = [
  ...
  // ARIZONA (8 cities)
  // ═══════════════════════════════════════════════════════════════
  createCity("Phoenix", "Arizona", "AZ", "arizona", 1680992, ["Real Estate", "Tech", "Healthcare", "Finance", "Logistics"], "The Southwest's fastest-growing creator market", "Phoenix is America's fastest-growing major city for 5 years running"),
  ...
  // COLORADO (7 cities)
  // ═══════════════════════════════════════════════════════════════
  createCity("Denver", "Colorado", "CO", "colorado", 727211, ["Cannabis", "Outdoor Recreation", "Tech", "Healthcare", "Aerospace"], "The outdoor lifestyle and wellness content capital", "Denver is the #1 city for fitness and outdoor influencers"),
  ...
  // FLORIDA (12 cities)
  // ═══════════════════════════════════════════════════════════════
  createCity("Miami", "Florida", "FL", "florida", 467963, ["Real Estate", "Luxury", "Crypto", "Hospitality", "Fashion"], "The gateway to Latin America and luxury lifestyle", "Miami's influencer economy grew 340% since 2020"),
  createCity("Tampa", "Florida", "FL", "florida", 399700, ["Finance", "Tech", "Healthcare", "Defense", "Tourism"], "Florida's business coast creator hub", "Tampa Bay is the fastest-growing tech hub in Florida"),
  createCity("Orlando", "Florida", "FL", "florida", 307573, ["Tourism", "Hospitality", "Tech", "Simulation", "Entertainment"], "Theme park capital meets creator economy", "Orlando is the most-visited city in America with 75M+ annual visitors"),
  createCity("Jacksonville", "Florida", "FL", "florida", 911507, ["Logistics", "Finance", "Healthcare", "Military", "Insurance"], "Florida's largest city with untapped potential", "Jacksonville is the largest city by land area in the continental US"),
  ...
  // GEORGIA (7 cities)
  // ═══════════════════════════════════════════════════════════════
  createCity("Atlanta", "Georgia", "GA", "georgia", 498715, ["Music", "Film", "Tech", "Healthcare", "Logistics"], "The entertainment capital of the South", "Atlanta produces more hip-hop content than any other city globally"),
  ...
  // ILLINOIS (8 cities)
  // ═══════════════════════════════════════════════════════════════
  createCity("Chicago", "Illinois", "IL", "illinois", 2693976, ["Finance", "Advertising", "Food & Beverage", "Manufacturing", "Tech"], "The Midwest's marketing and media powerhouse", "Chicago has the 3rd largest advertising industry in the US"),
  ...
  // NEW YORK (10 cities)
  // ═══════════════════════════════════════════════════════════════
  createCity("New York", "New York", "NY", "new-york", 8336817, ["Finance", "Media", "Fashion", "Tech", "Entertainment"], "Dominate the world's most competitive market", "Home to 60,000+ influencers and the largest media industry"),
  ...
  // TENNESSEE (7 cities)
  // ═══════════════════════════════════════════════════════════════
  createCity("Nashville", "Tennessee", "TN", "tennessee", 670820, ["Music", "Healthcare", "Tourism", "Tech", "Publishing"], "Where music artists build empires", "Nashville's music industry generates $10B+ annually"),
  ...
  // TEXAS (15 cities)
  // ═══════════════════════════════════════════════════════════════
  createCity("Houston", "Texas", "TX", "texas", 2320268, ["Energy", "Healthcare", "Aerospace", "International Trade", "Tech"], "Energy capital meets diverse creator economy", "Houston is the most ethnically diverse city in America"),
  ...
  createCity("San Antonio", "Texas", "TX", "texas", 1547253, ["Military", "Healthcare", "Tourism", "Cybersecurity", "Bioscience"], "Military market meets Texas hospitality", "San Antonio has 4 major military bases"),
  ...
  // WASHINGTON (7 cities)
  // ═══════════════════════════════════════════════════════════════
  createCity("Seattle", "Washington", "WA", "washington", 737015, ["Tech", "E-commerce", "Gaming", "Coffee", "Aerospace"], "Where tech giants and indie creators coexist", "Seattle has more software developers per capita than any US city"),
