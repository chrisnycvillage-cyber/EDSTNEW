    ...
    <section className="relative min-h-screen flex items-center justify-center overflow-hidden pt-16">
      ...
      <div className="section-container relative z-10 py-20">
        <div className="max-w-5xl mx-auto">
          ...
          {/* Main headline - UNIQUE per city, SEO optimized */}
          <motion.div
          ...
          >
            {/* H1 is UNIQUE for each city - critical for SEO */}
            <h1 className="font-heading font-bold text-edst-white leading-[1.08] mb-6 text-3xl sm:text-4xl md:text-5xl lg:text-6xl">
              {h1}
            </h1>

            {/* Subheadline is UNIQUE for each city */}
            <p className="text-lg md:text-xl text-edst-silver max-w-2xl mx-auto leading-relaxed">
              {subheadline}
            </p>
          </motion.div>
